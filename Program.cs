...
namespace TrackerApplication
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            dynamic objTracker1 = LoadFile(filePath);
            dynamic objTracker2 = LoadFile(filePath2);

            // Map objects 
            TrackerDataFoo1 data1 = GetSensorDataFile1(objTracker1);
            TrackerDataFoo2 data2 = GetSensorDataFile2(objTracker2);

            // Merge Results into common Object
            MergeResults(data1, data2, SummaryData);
        ...
        private static void MergeResults(TrackerDataFoo1 data1, TrackerDataFoo2 data2, List<DataSummary> SummaryData)
        {
        ...
        private static void DisplayResults(List<DataSummary> SummaryData)
        {
        ...
        private static TrackerDataFoo1 GetSensorDataFile1(dynamic objTracker1)
        {
        ...
        private static TrackerDataFoo2 GetSensorDataFile2(dynamic objTracker2)
        {
        ...
        private static dynamic LoadFile(string filePath)
        {
